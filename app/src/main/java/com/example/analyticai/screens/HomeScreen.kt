...
@Composable
fun HomeScreen(navegacao: NavController?) {
    ...
    Column(
        ...
        BoxWithConstraints(
            ...
            Column(
                ...
                Spacer(modifier = Modifier.height(alturaTela * 0.1f))
        ...
        BoxWithConstraints(
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                ...
                Column(
                    ...
                    Spacer(modifier = Modifier.height(alturaTela * 0.08f))
                    Text(
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            InfoCard(
                                ...
                                description = R.string.dashboard
                            )
                        }
                        ...
                        Row(
                            ...
                            InfoCard(
                                ...
                                description = R.string.notificacoes
                            )
                        }
                    }
                }
        ...
        BoxWithConstraints(
            ...
            Column(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(R.string.familia),
                        fontSize = 12.sp,
                        textAlign = TextAlign.Center,
                        fontWeight = FontWeight.ExtraLight,
                ...
                Spacer(modifier = Modifier.height(alturaTela * 0.15f))
